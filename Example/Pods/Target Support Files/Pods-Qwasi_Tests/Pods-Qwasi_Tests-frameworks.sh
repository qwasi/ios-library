...
install_framework()
{
  local source="${BUILT_PRODUCTS_DIR}/Pods-Qwasi_Tests/$1"
...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  install_framework 'AFJSONRPCClient.framework'
  install_framework 'AFNetworking.framework'
  install_framework 'BlocksKit.framework'
  install_framework 'CocoaLumberjack.framework'
  install_framework 'Emitter.framework'
  install_framework 'Expecta.framework'
  install_framework 'GBDeviceInfo.framework'
  install_framework 'QSwizzle.framework'
  install_framework 'Qwasi.framework'
